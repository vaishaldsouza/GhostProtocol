...
import { Cpu, BarChart3, BellRing, ShieldCheck, Mic, MapPin, ArrowRight, Languages } from 'lucide-react';
...
export const FeaturesSection: React.FC<FeaturesSectionProps> = ({ onSelectFeature }) => {
  const features = [
    ...
    },
    {
      ...
      description: 'Full UI & guidance in English, Hindi, Tamil, Telugu, Bengali, and Marathi — serve every patient in their own language.',
      icon: Languages,
    },
    {
      id: 'smart-routing',
